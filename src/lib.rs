...
#[derive(Debug)]
pub struct Web3HubProcessor {
    verbose: bool,
    processed_count: usize,
}

impl Web3HubProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting Web3Hub processing");
    
    let mut processor = Web3HubProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = Web3HubProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = Web3HubProcessor::new(false);
